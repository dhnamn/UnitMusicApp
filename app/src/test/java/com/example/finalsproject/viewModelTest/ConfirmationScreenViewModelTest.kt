...
//class ConfirmationScreenViewModelTest {
//    @get: Rule
...
//
//    private lateinit var viewModel: ConfirmationScreenViewModel
//
...
////        savedStateHandler = SavedStateHandle(mapOf(Pair("abcABC123.","abcABC123.")))
//        savedStateHandler
//        viewModel = ConfirmationScreenViewModel(savedStateHandler, authRepo, credentialsRepo)
//    }
//
//    @After
//    fun teardown() {
...
//
//    @Test
//    fun confirmationScreenViewModelTest_onOtpChange() = runBlocking {
//        val newOtp = TextFieldValue("123456")
//        viewModel.onOtpChange(newOtp)
//        Assert.assertEquals(viewModel.state.value.otpFieldValue, newOtp)
//    }
//
//    @Test
